...
export class PromoCodeListComponent implements OnInit {
  ...
  public getFormData() {
    this.dynamicService.getFormSettings('PromoCodeSearchForm').subscribe(res => {
  ...
  public getListSettings() {
    this.dynamicService.getListSettings('PromoCodeList').subscribe(res => {
  ...
  public getListData(pageSize?: number, pageNumber?: number) {
    ...
    this.baseService.postItem(Controllers.PromoCode, Actions.GetList, request).subscribe(res => {
  ...
  public serveAction(event: DynamicFormOutput) {
    ...
    this.baseService.postItem(Controllers.PromoCode, Actions.GetList, event.data).subscribe(res => {
      this.promoCodesList = res.entities;
      this.dynamicListInput.data = this.promoCodesList;
      this.dynamicListInput.totalCount = res.totalCount;
      this.isLoading = false;
      ...
      case ListActionTypeEnum.Delete:
        {
          ...
          dialogRef.afterClosed().subscribe(res => {
            if (res) {
              this.spinner.show();
              this.baseService.removeItemById(Controllers.PromoCode, event.entityId).subscribe(res => {
