...
export class RecordListComponent implements OnInit {
  ...
  public getFormData() {
    this.baseService.getAllForList(Controllers.AreaGroup).subscribe(res => {
      this.areaGroups = res;
      this.dynamicService.getFormSettings('RecordSearchForm').subscribe(res => {
  ...
  public getListSettings() {
    this.dynamicService.getListSettings('RecordList').subscribe(res => {
  ...
  public getListData(pageSize?: number, pageNumber?: number) {
    ...
    this.baseService.postItem(Controllers.Record, Actions.GetList, request).subscribe(res => {
  ...
  public serveAction(event: DynamicFormOutput) {
    ...
    this.baseService.postItem(Controllers.Record, Actions.GetList, event.data).subscribe(res => {
      this.recordList = res.result.entities;
      this.dynamicListInput.data = this.recordList;
