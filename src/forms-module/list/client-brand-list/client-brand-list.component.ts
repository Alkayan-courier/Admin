...
import { ClientBrandSearchForm, ClientBrandsList } from '../../dynamic-data';
...
export class ClientBrandListComponent implements OnInit {
  ...
  public getFormData() {
    this.dynamicFormInput = ClientBrandSearchForm;
    this.getListSettings();
  }
  public getListSettings() {
    this.dynamicListInput.columns = ClientBrandsList;
    this.getListData();
  }
  public getListData(pageSize?: number, pageNumber?: number) {
    ...
    this.baseService
      .postItem(Controllers.ClientBrand, Actions.GetList, request)
      .subscribe((res) => {
  ...
  public serveAction(event: DynamicFormOutput) {
    ...
    this.baseService
      .postItem(Controllers.ClientBrand, Actions.GetList, event.data)
      .subscribe((res) => {
      ...
      case ListActionTypeEnum.Delete: {
        ...
        dialogRef.afterClosed().subscribe((res) => {
          if (res) {
            ...
            this.baseService
              .removeItemById(Controllers.ClientBrand, event.entityId)
              .subscribe(
                (res) => {
