...
export class EndUsersListComponent implements OnInit {
  ...
  public getFormData() {
    this.baseService.getItemsByKey(Controllers.User, Actions.GetAllItems, 'role', this.userRolesEnum.EndUser).subscribe(res => {
      this.endusers = res;
      console.log('EndUser',res)
  ...
  public getListData(pageSize?: number, pageNumber?: number) {
    ...
    this.baseService.postItem(Controllers.User, Actions.GetList, request).subscribe(res => {
      console.log(res);  this.endusers = res.entities;
