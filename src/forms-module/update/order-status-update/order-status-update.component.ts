...
export class OrderStatusUpdateComponent implements OnInit {
  ...
  public getFieldsData(orderStatus: any) {
    this.dynamicService.getFormSettings('OrderStatusForm').subscribe(res => {
  ...
  public serveAction(event: DynamicFormOutput) {
    ...
    this.baseService.postFormItem(Controllers.OrderStatus, Actions.EditItem, formData).subscribe(res => {
