...
export class DynamicListComponent implements OnInit, DoCheck {
  ...
  @Output() listActionClickedEvent: EventEmitter<ListActionClickedOutput> =
    new EventEmitter<ListActionClickedOutput>();
  ...
  public downloadFile(fileName: string) {
    this.spinner.show();
    return this.baseService.downloadFile(fileName).subscribe(
      (res) => {
